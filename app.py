...
<div class="hero-container">
    <div style="margin-bottom:0.8rem;">
        ...
        <span class="hero-badge" style="background:rgba(188,140,255,0.15);border-color:rgba(188,140,255,0.3);color:#BC8CFF;">🎓 Andhra University</span>
    </div>
...
<div class="footer-bar">
    🛰️ &nbsp; CoolCity AI &nbsp;|&nbsp; 3 CODES & 1 CIRCUIT &nbsp;|&nbsp; Andhra University &nbsp;|&nbsp;
